# CLAUDE.md — Bootstrap IA: Spec Driven Development for AI-Powered Project Generation

> This file is the entrypoint for Claude Code. It aggregates all rules from Bootstrap IA.
> Rules are organized into **Core** (SDD workflow), **Global** (always apply), and **Specific** (technology-dependent).
